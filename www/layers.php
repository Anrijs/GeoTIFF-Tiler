<?php
  ...
  foreach ($layers as $layer) {
    ...
    $body .= '<tr><td>1</td><td>'.$name.'</td><td>'.$zoom.'</td><td>'.(sizeof($maps)-1).'</td><td><a href="map.php#layers='.$name.'" class="btn btn-sm btn-info" style="margin-right:4px;">View layer</a><a href="#" class="btn btn-sm btn-danger">Delete</a></td>';    
  }
  $body .= '</table>';
